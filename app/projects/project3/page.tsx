...
export default function Project1Page() {
  const images = [
    `${imageBasePath}/project3-preview.png`,
    `${imageBasePath}/project3-1.png`,
    `${imageBasePath}/project3-2.png`,
    `${imageBasePath}/project3-3.png`,
    `${imageBasePath}/project3-4.png`,
  ];
      ...
      >
        <div className="flex flex-col items-center md:items-start w-full md:w-auto">
          ...
          <p className="text-sm md:text-base text-gray-700 dark:text-gray-300 mt-1 text-center md:text-left">
            A Ruby on Rails-based Award Management System
          </p>
        </div>
      ...
      <div className="backdrop-blur-md bg-white/40 dark:bg-white/10 rounded-2xl shadow-md border border-pink-200/30 dark:border-blue-800/30 p-8 space-y-5">
        ...
        <h3>🌸 Key Features</h3>
         <div className="box-white">
          <TypewriterList
            items={[
              "ulk import via Excel files",
              "Award management dashboard",
              "Multi-tenant for different States",
